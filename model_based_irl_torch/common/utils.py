...
def get_maniskill_dataset_path_and_env_meta(config, env_id=None, done_mode=0):
    """Return ManiSkill success/failure dataset paths and optional env metadata."""
    del env_id, done_mode
