...
#         cv2.waitKey(frame_delay)  # Wait for the specified frame delay
        ...
        ep_data_grp.attrs["label"] = label  # Save the label for this demo
        ...
        if label == 0:
            ...
            ep_data_grp = data_grp_filtered.create_group("demo_{}".format(new_index)) 
            ...
            total_samples += f_in["data"][demo_key].attrs["num_samples"]
            new_index += 1
